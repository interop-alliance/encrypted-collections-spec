...
the resource log profile (the hash-linked log form under which descriptors
and key rosters are co-managed), recipient management, and the
deferred-minting rules for local-first writers.
